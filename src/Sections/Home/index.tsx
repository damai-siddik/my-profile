...
export default function Home() {
    return (
        <section id="home" className="pt-8 pb-16 home ">
          <div className="flex flex-col md:flex-row-reverse justify-between items-center mx-6 pt-14 gap-8 md:gap-24">
            <div className='w-full flex flex-col justify-center items-center gap-8 md:items-center md:w-1/2'>
              <div className="bg-inherit">
                <img src="/damai.jpeg" alt="image" className='rounded-full w-[200px] h-[200px] md:w-[250px] md:h-[250px]' />
              </div>
            </div>
            <div className='w-full text-center flex flex-col items-center justify-center md:items-start md:w-1/2'>
